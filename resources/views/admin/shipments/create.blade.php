                        ...
                        <div class="col-md-6">
                            <div class="card card-info border border-info">
                                ...
                                <div class="card-body">
                                    ...
                                    <x-input-field name="shipper.primary_contact" type="tel" :value="$shipment->shipper->phone" placeholder="Contact no" prepend="icon:fas fa-phone-alt" required="true" />
                        ...
                        <div class="col-md-6">
                            <div class="card card-info border border-info">
                                ...
                                <div class="card-body">
                                    ...
                                    <x-input-field name="receiver.primary_contact" type="tel" :value="$shipment->receiver->phone" placeholder="Contact no" prepend="icon:fas fa-phone-alt" required="true" />
                        ...
                        <div class="col-md-4 offset-md-1">
                            ...
                            <x-input-field class="billed_weight"  min="0" step="0.01" name="billed_weight" type="number" :value="$shipment->billed_weight" inline="true" row="true" label="Billed Weight" append="KG" />
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="input-group input-group-sm col-sm-10 col-md-8">
                                    <input type="number" name="billing[extra_charge]" max="99999" class="form-control form-control-sm @error('billing.extra_charge') is-invalid @enderror extraCharge billing" value="{{old('billing.extra_charge')}}">
                                    <div class="input-group-append"><span class="input-group-text">Taka</span></div> 
                                 </div>
                             </div>
                             <hr>
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="input-group input-group-sm col-sm-10 col-md-8">
                                    <input type="number" name="billing[total_paid]" max="999999" class="form-control form-control-sm @error('billing.total_paid') is-invalid @enderror totalPaid billing" value="{{old('billing.total_paid')}}">
                                    <div class="input-group-append"><span class="input-group-text">Taka</span></div> 
                                 </div>
                             </div>
                            <!--  <div class="form-group row">
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="input-group input-group-sm col-sm-10 col-md-8">
                                    <input type="number" max="99999" class="form-control form-control-sm totalDue" readonly>
                                    <div class="input-group-append">
                                        <span class="input-group-text">
                                        Taka
                                         </span>
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="input-group input-group-sm col-sm-10 col-md-8">
                                    <input type="text"  name="billing[remark]" max="190" class="form-control form-control-sm" value="{{old('billing.remark')}}">
                                 </div>
                             </div>
                        </div>
                        @endcan
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group row">
                                ...
                                <input type="text" list="received_by" name="received_by" class="form-control form-control-sm col-sm-8 @error('received_by') is-invalid @enderror" value="{{old('received_by')}}">
                            </div>
                            <datalist id="received_by">
                              <option value="surman">
                            </datalist>
                        </div>
